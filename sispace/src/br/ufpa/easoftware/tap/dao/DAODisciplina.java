...
import br.ufpa.easoftware.tap.model.Disciplina;
...
public class DAODisciplina {
    ...
    public boolean existeDisciplinaPorId(Disciplina disciplina){
    ...
    public boolean existeDisciplinaPorNome(Disciplina disciplina){
        String nome = null;
        int idDisciplina = 0;
    ...
    public List<Disciplina> recuperaDisciplinaPorId(int idDisciplina){                
        ...
        List listDisciplina = new ArrayList<Disciplina>();

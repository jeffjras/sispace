...
public class DAOProfessor {
    ...
    public boolean existeProfessorPorId(Professor professor){
    ...
    public boolean existeProfessorPorNome(Professor professor){
        String nome = null;
        int id = 0;
    ...
    public List<Professor> recuperaProfessorPorId(int idProfessor){                
        sql = "SELECT id_professor, nome, status FROM professores WHERE id_professor="+idProfessor;
        List listProfessor = new ArrayList<Professor>();

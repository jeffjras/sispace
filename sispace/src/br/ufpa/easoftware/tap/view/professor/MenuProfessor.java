...
public class MenuProfessor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("4) Lista professor em ordem de código");
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        switch (opcao) {
            ...
            case "2": 
            {
                AltProfessor altProfessor = new AltProfessor();
            ...
            case "3": 
            {
                ExcProfessor excProfessor = new ExcProfessor();
            ...
            case "4": 
            {
                ListProfessor listProfessor = new ListProfessor(1);                
            ...
            case "5": 
            {
                ListProfessor listProfessor = new ListProfessor(2);                
                listProfessor.setVisible(true);                
                jTextField1.setText("");
                break;
            }

 ...
 * @author UEPA_LAB6
 */
public class CadTipoEventos extends javax.swing.JFrame {

    /**
     * Creates new form CadProduto
     */
    public CadTipoEventos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CADASTRA TIPO DE EVENTOS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        daoTipoEventos.inserir(tipoEve);
        JOptionPane.showMessageDialog(null, "Tipo de Eventos inserido com sucesso!");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadTipoEventos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadTipoEventos().setVisible(true);
            }
        });
    }

...
public class MenuDisciplina extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("4) Lista disciplina em ordem de código");
        ...
        jLabel7.setText("5) Lista disciplina em ordem alfabética");
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        switch (opcao) {
            ...
            case "2": 
            {
                AltDisciplina altDisciplina = new AltDisciplina();
                altDisciplina.setVisible(true);
                jTextField1.setText("");
                break;
            }
            case "3": 
            {
                ExcDisciplina excDisciplina = new ExcDisciplina();
                excDisciplina.setVisible(true);
                jTextField1.setText("");
                break;
            }
            case "4": 
            {
                ListDisciplina listDisciplina = new ListDisciplina(1);                
                listDisciplina.setVisible(true);                
                jTextField1.setText("");
                break;
            }
            case "5": 
            {
                ListDisciplina listDisciplina = new ListDisciplina(2);                
                listDisciplina.setVisible(true);                
                jTextField1.setText("");
                break;
            }
